...
public class GcodeDisplaySsh3dP : MonoBehaviour
{
    ...
    private static readonly string Command = "cd printer_data/gcodes; ls";
    ...
    void Start()
    {
        ...
        UnityEngine.Debug.Log("Gcode Display Listner added");
    }

    private void OnButtonClick()
    {
        UnityEngine.Debug.Log("Gcode Display Button Triggered");
        RunSshScript();
    }

    private void ParseRawData(string rawData)
    {
        string [] files = rawData.Split(new string[] {Environment.NewLine },StringSplitOptions.None);
        ...
        try
        {
            ...
            using (var client = new SshClient(Host, Username, Password))
            {
                ...
                if (client.IsConnected)
                {
                    ...
                    var rawData = commandResult.Result;
