...
public class AddGcodeSsh3dP : MonoBehaviour
{
    ...
    private static readonly string Command = "python3 door_open.py";
    ...
    void Start()
    {
        ...
        UnityEngine.Debug.Log("Gcode Add Listner added");
    }

    private void OnButtonClick()
    {
        UnityEngine.Debug.Log("Gcode Add Button Triggered");
        RunSshScript();
    }
