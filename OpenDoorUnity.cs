...
public class OpenDoorUnity3dP : MonoBehaviour
{
    ...
    public float minY = 0f;    // Minimum Z position (closed position)
    public float maxY = 35f;  // Maximum Z position (open position)
