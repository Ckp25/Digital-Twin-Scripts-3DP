...
public class CloseDoorSsh3dP : MonoBehaviour
{
    ...
    private static readonly string Command = "python3 door_close.py";
    ...
    void Start()
    {
        ...
        UnityEngine.Debug.Log("Door Close Listner added");
    }

    private void OnButtonClick()
    {
        UnityEngine.Debug.Log("Door Close Button Triggered");
        RunSshScript();
    }
